...
class TelegramHandler {
    ...
    public static function send_message( $bot_token, $chat_ids, $form_data, $form_title ): WP_Error|true {
        if (empty( $bot_token ) || empty( $chat_ids )) {
            return new WP_Error( 'telegram_config_error', 'Telegram bot token or chat IDs not configured', [ 'status' => 500 ] );
        }
        ...
        return new WP_Error( 'telegram_send_error', $error_message, [ 'status' => 500 ] );
    }
