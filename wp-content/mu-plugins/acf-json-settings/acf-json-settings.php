<?php
/**
 * Plugin Name: ACF JSON Settings
 * Description: Configure ACF Local JSON save/load paths and ensure directories exist.
 * Author: AA Softsport
 */
...
add_filter('acf/settings/load_json', function ($paths) {
	...
	foreach (array($child_theme_path, $parent_theme_path, $content_fallback) as $path) {
		if (is_dir($path)) {
			$paths[] = $path;
		}
	}
